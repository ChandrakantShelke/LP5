...
int main() {
    ...
    cout<<"beta 0 :" <<beta0_seq<<", beta 1"<<beta1_seq<<", Time"<<time_seq<<"s\n";
    cout<<"Line Execution (Sequential): y"<<beta1_seq<<"x +" <<beta0_seq<<endl;

    cout<<"Parallel Execution : \n";
    cout<<"beta 0 :" <<beta0_par<<", beta 1"<<beta1_par<<", Time"<<time_par<<"s\n";
    cout<<"Line Execution (Parallel): y"<<beta1_par<<"x +" <<beta0_par<<endl;
